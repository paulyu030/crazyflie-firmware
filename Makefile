...
VPATH += $(CRAZYFLIE_BASE)/src/modules/src/PID_controller_ert_rtw $(CRAZYFLIE_BASE)/src/modules/src/Quaternion_controller_ert_rtw $(CRAZYFLIE_BASE)/src/modules/src/thrust_test_ert_rtw
VPATH += $(CRAZYFLIE_BASE)/src/modules/src/single_qc_real_ert_rtw $(CRAZYFLIE_BASE)/src/modules/src/single_qc_ppid_ert_rtw
...
PROJ_OBJ += single_qc_ppid.o single_qc_ppid_data.o
...
PROJ_OBJ += controller.o controller_pid.o controller_mellinger.o controller_quaternion.o controller_thrust.o controller_single.o controller_single_ppid.o
...
INCLUDES += -I$(CRAZYFLIE_BASE)/src/modules/src/PID_controller_ert_rtw -I$(CRAZYFLIE_BASE)/src/modules/src/Quaternion_controller_ert_rtw -I$(CRAZYFLIE_BASE)/src/modules/src/thrust_test_ert_rtw
INCLUDES += -I$(CRAZYFLIE_BASE)/src/modules/src/single_qc_real_ert_rtw -I$(CRAZYFLIE_BASE)/src/modules/src/single_qc_ppid_ert_rtw
