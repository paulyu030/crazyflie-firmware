...
VPATH += $(CRAZYFLIE_BASE)/src/modules/src/PID_controller_ert_rtw $(CRAZYFLIE_BASE)/src/modules/src/Quaternion_single_axis_controller_ert_rtw $(CRAZYFLIE_BASE)/src/modules/src/thrust_test_ert_rtw
...
PROJ_OBJ += controller.o controller_pid.o controller_mellinger.o controller_quaternion.o controller_thrust.o 
...
INCLUDES += -I$(CRAZYFLIE_BASE)/src/modules/src/PID_controller_ert_rtw -I$(CRAZYFLIE_BASE)/src/modules/src/Quaternion_single_axis_controller_ert_rtw -I$(CRAZYFLIE_BASE)/src/modules/src/thrust_test_ert_rtw
