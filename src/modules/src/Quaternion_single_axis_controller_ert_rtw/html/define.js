...
this.def["Quaternion_single_axis_contr_DW"] = {file: "Quaternion_single_axis_controller_c.html",line:24,type:"var"};
this.def["Quaternion_single_axis_contro_U"] = {file: "Quaternion_single_axis_controller_c.html",line:27,type:"var"};
this.def["Quaternion_single_axis_contro_Y"] = {file: "Quaternion_single_axis_controller_c.html",line:30,type:"var"};
this.def["Quaternion_single_axis_contr_M_"] = {file: "Quaternion_single_axis_controller_c.html",line:33,type:"var"};
this.def["Quaternion_single_axis_contr_M"] = {file: "Quaternion_single_axis_controller_c.html",line:34,type:"var"};
this.def["Quaternion_single_axis_controller_step"] = {file: "Quaternion_single_axis_controller_c.html",line:38,type:"fcn"};
this.def["Quaternion_single_axis_controller_initialize"] = {file: "Quaternion_single_axis_controller_c.html",line:298,type:"fcn"};
this.def["Quaternion_single_axis_controller_terminate"] = {file: "Quaternion_single_axis_controller_c.html",line:335,type:"fcn"};
this.def["DW_Quaternion_single_axis_con_T"] = {file: "Quaternion_single_axis_controller_h.html",line:47,type:"type"};
this.def["ExtU_Quaternion_single_axis_c_T"] = {file: "Quaternion_single_axis_controller_h.html",line:63,type:"type"};
this.def["ExtY_Quaternion_single_axis_c_T"] = {file: "Quaternion_single_axis_controller_h.html",line:72,type:"type"};
this.def["P_Quaternion_single_axis_cont_T"] = {file: "Quaternion_single_axis_controller_types_h.html",line:25,type:"type"};
this.def["RT_MODEL_Quaternion_single_ax_T"] = {file: "Quaternion_single_axis_controller_types_h.html",line:28,type:"type"};
this.def["Quaternion_single_axis_contro_P"] = {file: "Quaternion_single_axis_controller_data_c.html",line:24,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["Quaternion_single_axis_controller_c.html"] = "../Quaternion_single_axis_controller.c";
	this.html2Root["Quaternion_single_axis_controller_c.html"] = "Quaternion_single_axis_controller_c.html";
	this.html2SrcPath["Quaternion_single_axis_controller_h.html"] = "../Quaternion_single_axis_controller.h";
	this.html2Root["Quaternion_single_axis_controller_h.html"] = "Quaternion_single_axis_controller_h.html";
	this.html2SrcPath["Quaternion_single_axis_controller_private_h.html"] = "../Quaternion_single_axis_controller_private.h";
	this.html2Root["Quaternion_single_axis_controller_private_h.html"] = "Quaternion_single_axis_controller_private_h.html";
	this.html2SrcPath["Quaternion_single_axis_controller_types_h.html"] = "../Quaternion_single_axis_controller_types.h";
	this.html2Root["Quaternion_single_axis_controller_types_h.html"] = "Quaternion_single_axis_controller_types_h.html";
	this.html2SrcPath["Quaternion_single_axis_controller_data_c.html"] = "../Quaternion_single_axis_controller_data.c";
	this.html2Root["Quaternion_single_axis_controller_data_c.html"] = "Quaternion_single_axis_controller_data_c.html";
