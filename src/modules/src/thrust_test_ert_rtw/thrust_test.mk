###########################################################################
## Makefile generated for Simulink model 'thrust_test'. 
## 
## Makefile     : thrust_test.mk
## Generated on : Wed Feb 19 18:18:16 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\thrust_test.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Dropbox\ControlLab\Quadcopter\matlabworkspace\crazyflie_low_level_simulink
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = thrust_test_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = thrust_test_ref.rsp
CMD_FILE                  = thrust_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\thrust_test.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\thrust_test_ert_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=thrust_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\thrust_test_ert_rtw\thrust_test.c

MAIN_SRC = $(START_DIR)\thrust_test_ert_rtw\ert_main.c
...
{$(START_DIR)\thrust_test_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\thrust_test_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
