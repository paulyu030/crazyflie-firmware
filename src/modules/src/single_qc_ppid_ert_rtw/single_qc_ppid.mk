...
## Generated on : Tue Aug 04 04:04:58 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\single_qc_ppid.exe
...
PRODUCT_NAME              = single_qc_ppid
MAKEFILE                  = single_qc_ppid.mk
MATLAB_ROOT               = C:\PROGRA~1\POLYSP~1\R2020a
MATLAB_BIN                = C:\PROGRA~1\POLYSP~1\R2020a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Dropbox\ControlLab\Quadcopter\matlabworkspace\crazyflie_low_level_simulink\single_qc_ppid
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = single_qc_ppid_comp.rsp
CMD_FILE                  = single_qc_ppid.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\single_qc_ppid.exe
...
DEFINES_STANDARD = -DMODEL=single_qc_ppid -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\single_qc_ppid_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\single_qc_ppid_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
single_qc_ppid.obj : $(START_DIR)\single_qc_ppid_ert_rtw\single_qc_ppid.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\single_qc_ppid_ert_rtw\single_qc_ppid.c


single_qc_ppid_data.obj : $(START_DIR)\single_qc_ppid_ert_rtw\single_qc_ppid_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\single_qc_ppid_ert_rtw\single_qc_ppid_data.c
